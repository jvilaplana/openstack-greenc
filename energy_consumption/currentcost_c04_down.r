...
plot(compute01$V8, ylab="", xlab="", type="l",col="blue",ylim=c(0,245), lwd=1,xaxt="n", cex.axis=1.8, cex.lab=1.8)
axis(1,labels=FALSE, tck=0)
lab <- c(levels(compute01$V3)[1], levels(compute01$V3)[230], levels(compute01$V3)[459])
...
plot(compute02$V8, ylab="", xlab="", type="l",col="red",ylim=c(0,245), lwd=1,xaxt="n", cex.axis=1.8, cex.lab=1.8)
axis(1,labels=FALSE, tck=0)
lab <- c(levels(compute01$V3)[1], levels(compute01$V3)[230], levels(compute01$V3)[459])
text(c(0, 68, 137), par("usr")[3]-7,srt=45,adj=1,labels=lab,xpd=TRUE, cex=1.8)
...
plot(compute03$V8, ylab="", xlab="", type="l",col="green",ylim=c(0,245), lwd=1,xaxt="n", cex.axis=1.8, cex.lab=1.8)
axis(1,labels=FALSE, tck=0)
lab <- c(levels(compute01$V3)[1], levels(compute01$V3)[230], levels(compute01$V3)[459])
text(c(0, 68, 137), par("usr")[3]-7,srt=45,adj=1,labels=lab,xpd=TRUE, cex=1.8)
...
plot(compute04$V8, ylab="", xlab="", type="l",col="orange",ylim=c(0,245), lwd=1,xaxt="n", cex.axis=1.8, cex.lab=1.8)
axis(1,labels=FALSE, tck=0)
lab <- c(levels(compute01$V3)[1], levels(compute01$V3)[230], levels(compute01$V3)[459])
text(c(0, 68, 137), par("usr")[3]-7,srt=45,adj=1,labels=lab,xpd=TRUE, cex=1.8)
